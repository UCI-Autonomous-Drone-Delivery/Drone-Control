...
public:
    ...
    bool execute(const DroneCommandParameters& params) 
    {
        ...
        std::cout << "[Successfully armed the drone]" << std::endl;
        return false;
    }
};
...
public:
    ...
    bool execute(const DroneCommandParameters& params) 
    {
        ...
        std::cout << "[Successfully disarmed the drone]" << std::endl;
        return false;
    }
};
...
public:
    ...
    bool execute(const DroneCommandParameters& params) 
    {
        ...
        std::cout << "[Successfully requested control of the drone]" << std::endl;
        return false;
    }
};
...
public:
    ...
    bool execute(const DroneCommandParameters& params) 
    {
        std::cout << "[Successfully released control of the drone]" << std::endl;
...
public:
    ...
    bool execute(const DroneCommandParameters& params) 
    {
        ...
        */
        ...
        // MY CODE
        float z;
        std::cout << "What altitude do you want the drone to fly to?: ";
        std::cin >> z;
        ...
        std::cout << "[Flying the drone to " << z << " at " << velocity << " m/s for " << duration << " seconds]" << std::endl;
...
public:
    ...
    bool execute(const DroneCommandParameters& params) 
    {
        ...
        */
        ...
        float vy = getSwitch("-vy").toFloat();
        float z = getSwitch("-z").toFloat();
        std::cout << "What Vx do you want the drone to fly at?" << std::endl;
        std::cin >> vx;
        std::cout << "What Vy do you want the drone to fly at?" << std::endl;
        std::cin >> vy;
        std::cout << "What Z do you want the drone to fly at?" << std::endl;
        std::cin >> z;
        //float duration = getSwitch("-duration").toFloat();
        float duration = 10;
        auto drivetrain = getDriveTrain();
...
public:
    ...
    bool execute(const DroneCommandParameters& params) 
    {
        ...
        std::cout << "What speed do you want the drone to fly in?" << std::endl;
        std::cout << "Vx: ";
        std::cin >> vx;
        std::cout << "Vy: ";
        std::cin >> vy;
        ...
        std::cout << "[Drone is flying at "<< vx <<" m/s in x, "<< vy <<" m/s in y, "<< vz <<" m/s in z]" << std::endl;
...
public:
    ...
    bool execute(const DroneCommandParameters& params) 
    {
        ...
        std::cout << "What speed do you want the drone to be flying at while at a specific altitude?" << std::endl;
        ...
        std::cout << "[Drone is flying at " << vx << " m/s and " << vx << " m/s at " << z <<" " << std::endl;
...
int main(int argc, const char *argv[]) {
    ...
    shell.showMessage(R"(
        ...
        Welcome to DroneShell 2.0.
        Type ? for help/list of commands.
    
    )");

    command_context.client.confirmConnection();
    std::cout << "Press Enter and type the command to begin: " << std::endl; std::cin.get();
